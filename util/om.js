	...
	var evalCaptcha = function (pchallengeLink) {
		...
		request.get(url, function (error, response, body) {
			if (!error && response.statusCode == 200) {
				...
				var RecaptchaState = eval(body.substring(0, close + 1)); // jshint ignore:line				// so i guess this could be it??
				challenge = RecaptchaState.challenge; // jshint ignore:line				// RecaptchaState was never declared??
